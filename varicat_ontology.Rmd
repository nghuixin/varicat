...
#rev_df  <- rev_df %>% filter(level1=="Clinical_characteristics")
...
#fn %>% saveNetwork( paste0('varicat_ontology_', '.html') )
webshot(filename, jpegname, vwidth = 200, vheight = 200, zoom = 0.8) 
...
fn %>% saveNetwork(file = 'varicat_ontology_clinical_characteristics.html')
